...
public class Main {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println();
			System.out.println(
					"AllProjectsRepositoriesFlatDirDirs: " + gradleScript.getAllProjectsRepositoriesFlatDirDirs());
			System.out.println();
			System.out.println("PluginManagementRepositories: " + gradleScript.getPluginManagementRepositories());
			System.out.println();
			System.out.println("DependencyResolutionManagementRepositories: "
					+ gradleScript.getDependencyResolutionManagementRepositories());
			System.out.println();
			System.out.println("DependencyResolutionManagementRepositoriesFlatDirDirs: "
